...
FUNCTION(ADD_BSV_PACKAGE PACKAGE)
	...
	ADD_CUSTOM_COMMAND(
		...
		DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${PACKAGE}.bsv
		WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR}
		)

	ADD_CUSTOM_TARGET(${PACKAGE} DEPENDS ${BLUESPEC_BSC_BDIR}/${PACKAGE}.bo ${CMAKE_CURRENT_SOURCE_DIR}/${PACKAGE}.bsv)
ENDFUNCTION()
...
FUNCTION(ADD_BLUESIM_TESTCASE PACKAGE TESTCASE)
	...
	ADD_CUSTOM_COMMAND(
		...
		COMMAND ${BLUESPEC_BSC_EXECUTABLE} ${BLUESPEC_BSC_SIM_OPTIONS} -e mkTB_${TESTCASE} -bdir ${BLUESPEC_BSC_BDIR} -L ${CMAKE_CURRENT_BINARY_DIR} ${BDPI_LIB_ARGS} -o ${CMAKE_BINARY_DIR}/test_${TESTCASE}
...
## NOTE: BSC -verilog outputs its files to the same folder as the source file, NOT its working directory
    ...
    ADD_CUSTOM_TARGET(verilog_${MODULE} DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/${MODULE}.v)
ENDFUNCTION()
