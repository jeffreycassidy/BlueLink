...
LIST(APPEND BLUESPEC_BSC_SIM_OPTIONS "-sim")
...
FUNCTION(ADD_BLUESIM_TESTCASE PACKAGE TESTCASE)
	...
	ADD_CUSTOM_COMMAND(
		...
		COMMAND bsc ${BLUESPEC_BSC_SIM_OPTIONS} -e mkTB_${TESTCASE} -bdir ${BLUESPEC_BSC_BDIR} -L ${CMAKE_CURRENT_BINARY_DIR} ${BDPI_LIB_ARGS} -o ${CMAKE_BINARY_DIR}/test_${TESTCASE}
