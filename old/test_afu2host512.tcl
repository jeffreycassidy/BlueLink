...
proc com {} {
    vlog -timescale 1ns/1ns +define+BSV_NO_INITIAL_BLOCKS +define+BSV_ASSIGNMENT_DELAY=\#1 Altera/MLAB_0l.v
...
#	add wave -noupdate -label "Buffer status $i" /top/a0/afurev/dut_streamctrl_bufferUsed_[serno $i]rv
#}
